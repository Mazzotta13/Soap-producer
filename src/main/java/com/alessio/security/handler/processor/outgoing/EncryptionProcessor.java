package com.alessio.security.handler.processor.outgoing;
...
import com.alessio.security.model.KeyIdentifierType;
import com.alessio.security.ssl.KeystoreInfo;
import com.alessio.security.utils.SOAPUtil;
...
public class EncryptionProcessor implements SoapMessageProcessor {
    ...
    public EncryptionProcessor(KeystoreInfo keystoreInfo) {
        ...
        // You must initialize the xml-com.alessio.security library correctly before you use it. Call the static method "org.apache.xml.com.alessio.security.Init.init();" to do that before you use any functionality from that library
